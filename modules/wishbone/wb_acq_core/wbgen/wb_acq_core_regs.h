...
/* definitions for field: FIFO write enable in reg: Status register */
#define ACQ_CORE_STA_FIFO_WE_MASK             WBGEN2_GEN_MASK(4, 1)
#define ACQ_CORE_STA_FIFO_WE_SHIFT            4
#define ACQ_CORE_STA_FIFO_WE_W(value)         WBGEN2_GEN_WRITE(value, 4, 1)
#define ACQ_CORE_STA_FIFO_WE_R(reg)           WBGEN2_GEN_READ(reg, 4, 1)

/* definitions for field: FIFO read enable in reg: Status register */
#define ACQ_CORE_STA_FIFO_RE_MASK             WBGEN2_GEN_MASK(5, 1)
#define ACQ_CORE_STA_FIFO_RE_SHIFT            5
#define ACQ_CORE_STA_FIFO_RE_W(value)         WBGEN2_GEN_WRITE(value, 5, 1)
#define ACQ_CORE_STA_FIFO_RE_R(reg)           WBGEN2_GEN_READ(reg, 5, 1)

/* definitions for field: FIFO flow control read enable in reg: Status register */
#define ACQ_CORE_STA_FIFO_FC_RD_EN_MASK       WBGEN2_GEN_MASK(6, 1)
#define ACQ_CORE_STA_FIFO_FC_RD_EN_SHIFT      6
#define ACQ_CORE_STA_FIFO_FC_RD_EN_W(value)   WBGEN2_GEN_WRITE(value, 6, 1)
#define ACQ_CORE_STA_FIFO_FC_RD_EN_R(reg)     WBGEN2_GEN_READ(reg, 6, 1)

/* definitions for field: FIFO empty in reg: Status register */
#define ACQ_CORE_STA_FIFO_RD_EMPTY_MASK       WBGEN2_GEN_MASK(7, 1)
#define ACQ_CORE_STA_FIFO_RD_EMPTY_SHIFT      7
#define ACQ_CORE_STA_FIFO_RD_EMPTY_W(value)   WBGEN2_GEN_WRITE(value, 7, 1)
#define ACQ_CORE_STA_FIFO_RD_EMPTY_R(reg)     WBGEN2_GEN_READ(reg, 7, 1)
...
/* definitions for field: FIFO write full in reg: Status register */
#define ACQ_CORE_STA_FIFO_WR_FULL_MASK        WBGEN2_GEN_MASK(10, 1)
#define ACQ_CORE_STA_FIFO_WR_FULL_SHIFT       10
#define ACQ_CORE_STA_FIFO_WR_FULL_W(value)    WBGEN2_GEN_WRITE(value, 10, 1)
#define ACQ_CORE_STA_FIFO_WR_FULL_R(reg)      WBGEN2_GEN_READ(reg, 10, 1)

/* definitions for field: FWFT FIFO valid output in reg: Status register */
#define ACQ_CORE_STA_FIFO_FC_VALID_FWFT_MASK  WBGEN2_GEN_MASK(11, 1)
#define ACQ_CORE_STA_FIFO_FC_VALID_FWFT_SHIFT 11
#define ACQ_CORE_STA_FIFO_FC_VALID_FWFT_W(value) WBGEN2_GEN_WRITE(value, 11, 1)
#define ACQ_CORE_STA_FIFO_FC_VALID_FWFT_R(reg) WBGEN2_GEN_READ(reg, 11, 1)

/* definitions for field: Flow control data required in reg: Status register */
#define ACQ_CORE_STA_SOURCE_PL_DREQ_MASK      WBGEN2_GEN_MASK(12, 1)
#define ACQ_CORE_STA_SOURCE_PL_DREQ_SHIFT     12
#define ACQ_CORE_STA_SOURCE_PL_DREQ_W(value)  WBGEN2_GEN_WRITE(value, 12, 1)
#define ACQ_CORE_STA_SOURCE_PL_DREQ_R(reg)    WBGEN2_GEN_READ(reg, 12, 1)

/* definitions for field: Flow control stall in reg: Status register */
#define ACQ_CORE_STA_SOURCE_PL_STALL_MASK     WBGEN2_GEN_MASK(13, 1)
#define ACQ_CORE_STA_SOURCE_PL_STALL_SHIFT    13
#define ACQ_CORE_STA_SOURCE_PL_STALL_W(value) WBGEN2_GEN_WRITE(value, 13, 1)
#define ACQ_CORE_STA_SOURCE_PL_STALL_R(reg)   WBGEN2_GEN_READ(reg, 13, 1)

/* definitions for field: Reserved in reg: Status register */
#define ACQ_CORE_STA_RESERVED2_MASK           WBGEN2_GEN_MASK(14, 2)
#define ACQ_CORE_STA_RESERVED2_SHIFT          14
#define ACQ_CORE_STA_RESERVED2_W(value)       WBGEN2_GEN_WRITE(value, 14, 2)
#define ACQ_CORE_STA_RESERVED2_R(reg)         WBGEN2_GEN_READ(reg, 14, 2)
...
/* definitions for field: FIFO write count in reg: Status register */
#define ACQ_CORE_STA_FIFO_WR_COUNT_MASK       WBGEN2_GEN_MASK(17, 15)
#define ACQ_CORE_STA_FIFO_WR_COUNT_SHIFT      17
#define ACQ_CORE_STA_FIFO_WR_COUNT_W(value)   WBGEN2_GEN_WRITE(value, 17, 15)
#define ACQ_CORE_STA_FIFO_WR_COUNT_R(reg)     WBGEN2_GEN_READ(reg, 17, 15)
...
/* definitions for field: Atom selection for internal trigger (atom within the channel selected by DTRIG_WHICH) in reg: Trigger configuration */
