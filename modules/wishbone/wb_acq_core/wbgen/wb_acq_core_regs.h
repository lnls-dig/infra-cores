...
#define ACQ_CORE_SHOTS_MULTISHOT_RAM_SIZE_MASK WBGEN2_GEN_MASK(16, 16)
#define ACQ_CORE_SHOTS_MULTISHOT_RAM_SIZE_SHIFT 16
#define ACQ_CORE_SHOTS_MULTISHOT_RAM_SIZE_W(value) WBGEN2_GEN_WRITE(value, 16, 16)
#define ACQ_CORE_SHOTS_MULTISHOT_RAM_SIZE_R(reg) WBGEN2_GEN_READ(reg, 16, 16)
